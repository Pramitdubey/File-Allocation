...
// Function to allocate contiguous blocks for the file
...
int main()
{
    ...
    for (int time = 0; time < 10; time++)
    {
        ...
        // Calculate and print fragmentation and wasted blocks
